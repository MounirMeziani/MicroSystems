...
COMPONENT GPRegisterBlock
	PORT(
		SIGNAL R0_in: IN STD_LOGIC;
		SIGNAL R1_in:  IN STD_LOGIC;
		SIGNAL R2_in: IN  STD_LOGIC;
		SIGNAL R3_in: IN STD_LOGIC;
		SIGNAL R4_in: IN STD_LOGIC;
		SIGNAL R5_in:  IN STD_LOGIC;
		SIGNAL R6_in: IN  STD_LOGIC;
		SIGNAL R7_in: IN  STD_LOGIC;
		SIGNAL R8_in: IN  STD_LOGIC;
		SIGNAL R9_in: IN  STD_LOGIC;
		SIGNAL R10_in: IN  STD_LOGIC;
		SIGNAL R11_in: IN  STD_LOGIC;
		SIGNAL R12_in: IN  STD_LOGIC;
		SIGNAL R13_in: IN  STD_LOGIC;
		SIGNAL R14_in: IN  STD_LOGIC;
		SIGNAL R15_in: IN  STD_LOGIC;
		SIGNAL clk : IN STD_LOGIC;
		SIGNAL clr : IN STD_LOGIC;
		SIGNAL d : IN STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R0_busmuxin: OUT  STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R10_busmuxin: OUT  STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R11_busmuxin: OUT STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R12_busmuxin: OUT STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R13_busmuxin: OUT STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R14_busmuxin: OUT STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R15_busmuxin: OUT STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R1_busmuxin: OUT STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R2_busmuxin: OUT STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R3_busmuxin: OUT STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R4_busmuxin: OUT STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R5_busmuxin: OUT STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R6_busmuxin: OUT STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R7_busmuxin: OUT STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R8_busmuxin: OUT STD_LOGIC_VECTOR(31 DOWNTO 0);
		SIGNAL R9_busmuxin: OUT STD_LOGIC_VECTOR(31 DOWNTO 0)
	);
